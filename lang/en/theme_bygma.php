...
$string['pluginname'] = 'Bygma';

$string['generalsettings'] = 'General';

$string['frontpagesettings'] = 'Front-page';
$string['frontpageslidertitle'] = 'Front-Page Slider';
$string['frontpagesliderdesc'] = 'Upload images for the front-page slider';

$string['frontpagemycourses'] = 'My Courses';
$string['frontpageavailablecourses'] = 'Available Courses';
